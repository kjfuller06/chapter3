...
water = st_read("hydro_restricted10km.gpkg")
...
#   writeRaster(water_r, paste0("hydro_relevance", i, ".tif"), overwrite = T)
#   
...
#   writeRaster(water_r, paste0("distancetoHydroLine_relevance", i, ".tif"), overwrite = T)
# }
