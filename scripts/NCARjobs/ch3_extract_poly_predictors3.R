...
# summary(g11)
# g11$stringybark[is.na(g11$stringybark)] = 0
# 
# g12 = st_read("ch3_forGAMs_poly_prefire180_bark2.gpkg")
# st_geometry(g12) = NULL
# summary(g12)
# g12$ribbonbark[is.na(g12$ribbonbark)] = 0
# 
...
# summary(g14)
# g14$wind.stdev[is.na(g14$wind.stdev)] = 0
# g14 = g14 |> 
#   dplyr::select(ID,
#                 winddir,   ## need to compare with isochron data
#                 wind.stdev,
#                 windspeed, ## need to compare with isochron data
#                 windgust)
# 
# g = g1 |> 
#   left_join(g2) |> 
...
# gref$winddiff = gref$aspect - gref$maxwd
# gref$winddiff = cos(gref$winddiff * pi / 180)
# summary(gref)
# nrow(gref)
# ## 1,727
# setwd("E:/chapter3/for GAMs")
