...
water = st_read("hydro_nonpere_restricted10km.gpkg")
...
for(i in c(1:3)){
  ...
  writeRaster(water_r, paste0("hydro_nonpere_relevance", i, ".tif"), overwrite = T)
  ...
  writeRaster(water_r, paste0("distancetoHydroLine_nonpere_relevance", i, ".tif"), overwrite = T)
}
