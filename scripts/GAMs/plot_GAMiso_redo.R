...
g6 = summedallfun(dat = fit, rugdat = rugdat.temp, config = "xy", lab2 = "Standard deviation in wind speed (km/hr)", 
                  # ymin = min(fit$ll), ymax = max(fit$ul),
                  ymin = ymin, ymax = ymax,
                  ab2 = max(fit$fit))
...
g7 = summedallfun(dat = fit, rugdat = rugdat.temp, config = "xy", lab2 = "Standard deviation in wind direction (radians)", 
                  # ymin = min(fit$ll), ymax = max(fit$ul),
                  ymin = ymin, ymax = ymax,
                  ab2 = max(fit$fit))
...
g8 = summedallfun(dat = fit, rugdat = rugdat.temp, config = "xy", lab2 = "Median distance to water (km)", 
                  # ymin = min(fit$ll), ymax = max(fit$ul),
                  ymin = ymin, ymax = ymax,
                  ab2 = max(fit$fit))
# plots ####
...
ggexport(plots, filename = paste0("GAMiso_redo.jpeg"), width = 8000, height = 1500, res = 250)
...
ggexport(g6, filename = paste0("windspeed.stdev_redo.png"), width = 1000, height = 1000, res = 250)
ggexport(g7, filename = paste0("wind.stdev_redo.png"), width = 1000, height = 1000, res = 250)
ggexport(g8, filename = paste0("water_redo.png"), width = 1000, height = 1000, res = 250)
